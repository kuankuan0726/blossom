      ...
      if ($(window).width() > 414) {
        ...
        $(".page5_left .fa-chevron-right").click(function () {
          ...
          if (i > 2) {
            ...
            $(".ul3 .mainpic:nth-child(" + (i - 1) + ") p").css({
              opacity: "1",
            });
        ...
        $(".page5_left .fa-chevron-left").click(function () {
          $(".page5_left .fa-chevron-right").css({ opacity: "1" });
          if (i < 5) {
            $(".ul3 .mainpic:nth-child(" + i + ") p").css({
              opacity: "1",
            });
            $(".ul3 .mainpic:nth-child(" + (i - 1) + ") p").css({
              opacity: "0",
            });
            $(".ul3 .mainpic:nth-child(" + i + ") img ").css({
              width: "100%",
            });
            $(".ul3 .mainpic:nth-child(" + i + ") ").animate(
              { width: "104.94px", top: "0", left: "7px" },
              1000
            );
            $(".ul3 .mainpic:nth-child(" + i + ")").css({});
